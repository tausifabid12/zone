...
const AllIndiaDelivery = () => {
    ...
    const { addToCart, cart, updateQuantity, totalAllIndiaPrice } = useCart();
            ...
            <View style={styles.cardContent}>
                <View style={
                    ...
                    < View style={{
                        ...
                        <Image
                            source={require("../../../assets/icons/cart/map.png")}
                        ...
                        < LinearGradient
                            colors={['rgba(226, 232, 240, 0.00)', '#E2E8F0']}
                            start={{ x: 1, y: 0 }}
                            end={{ x: 0, y: 0 }}
                            style={{
                                flexDirection: 'row',
                    ...
                    < View style={{
                        ...
                        {/* Item Section */}
                        {
                            cart?.filter(it => it?.deliveryOptions == 'allIndia')?.map(item =>
...
export default AllIndiaDelivery;
