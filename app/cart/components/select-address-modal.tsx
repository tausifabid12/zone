...
import { EllipsisHorizontalIcon, PlusIcon, XCircleIcon, XMarkIcon } from "react-native-heroicons/solid";
                                ...
                                <View key={item} style={[styles.item, {
                                    ...
                                    <View style={{
                                        ...
                                        <View style={[styles.itemDetails, {
                                            ...
                                            <Text variant="body-xs" style={{
                                                color: themeColors.neutral500
                                            }}>Flat No. 12, Ganga Apartments, 10 Bazullah  Road, T. Nagar, Chennai, Tamil Nadu, 600017 </Text>
